...
public struct MultiLineChartView: View {
    ...
    var frame = CGSize(width: 200, height: 200)
    ...
    public var body: some View {
        ZStack(alignment: .center){
            RoundedRectangle(cornerRadius: 20)
                ...
                .shadow(radius: self.dropShadow ? 3 : 0)
...
//            MultiLineChartView(data: [([8,23,54,32,12,37,7,23,43], GradientColors.orange)], title: "Line chart", legend: "Basic")
            MultiLineChartView(data: [([70,72,73,71,69,72], GradientColors.blue), ([9.2,10.2,11,10.5,9.8,8.8,8], GradientColors.orange), ([25,40,45,55,35,40,48], GradientColors.green)])
